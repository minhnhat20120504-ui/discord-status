...
new SlashCommandBuilder()
.setName("pause")
.setDescription("⏸️ Tạm dừng nhạc"),
...
.addUserOption(o =>
o.setName("user")
.setDescription("Người cần xem (bỏ trống = bạn)")
.setRequired(false)
)
].map(cmd => cmd.toJSON());
...
━━━━━━━━━━━━━━━
🔗 **Support server:**
[https://discord.gg/P9yeTvwKjB](https://discord.gg/P9yeTvwKjB)

👑 **Người làm bot:**
phamminhnhat__

🌐 **Website:**
[https://pmnx.pages.dev](https://pmnx.pages.dev)
`)
